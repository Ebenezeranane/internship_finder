    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center mb-5">
          <h2 class="text-black section-title ">Contact Us</h2>
          <hr>
          <p style="color: coral; font-size: 30px;">Send us your feedbacks</p>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-lg-6 mb-5">
          {!! Form::open(['method'=>'POST','action'=>'ContactController@store']) !!}
            ...
            <div class="form-group row">
              <div class="col-md-12">
                {!! Form::textarea('message', '', ['class'=>'form-control','placeholder'=>'Write your message','cols'=>'30','rows'=>'10' ]) !!}
                
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-6 ml-auto">
                {!! Form::submit('Send Us Message', ['class'=>'btn btn-block btn-primary text-white py-3 px-5 ']) !!} 

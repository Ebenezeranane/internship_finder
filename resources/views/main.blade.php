    ...
    <div class="row bg">
        <div class="container">
            <div class="text">
                ...
                <p style=" font-size: xx-large;">Login<label style="color: coral; font-weight: lighter;">Here!</label></p>
                <a href="/login" class="btn btn-primary">Student</a>
                
                <a href="/admin/login" class="btn btn-primary">Employer</a>
            </div>
        </div>
      </div>
